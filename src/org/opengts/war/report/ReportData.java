...
public abstract class ReportData
{
    ...
    **/
    ...
    {
        EventData ed[] = this.getEventData(null/*rcdHandler*/);
    ...
    protected EventData[] getEventData(DBRecordHandler<EventData> rcdHandler)
    {
        ...
        for (Iterator i = devList.iterator(); i.hasNext();) {
            ...
            try {
                ...
                EventData ed[] = this._getEventData(device, rcdHandler); // may be empty
                if (rptLimit < 0L) {
    ...
    **/
        ...
        DBRecordHandler<EventData> rcdHandler)
    {
        ...
        EventData ed[] = this._getEventData(deviceDB, ts, te, rcdHandler);
        this.maxEventDataCount = this.eventDataCount;
        return ed;
    }
    ...
    ***         DBRecordHandler has been specified).
    **/
    protected EventData[] _getEventData(final Device deviceDB, 
        final DBRecordHandler<EventData> rcdHandler)
    {
        long timeStart = this.getTimeStart();
        long timeEnd   = this.getTimeEnd();
        return this._getEventData(deviceDB, timeStart, timeEnd, rcdHandler);
    }
        ...
        final DBRecordHandler<EventData> rcdHandler)
    {
        ...
        DBRecordHandler<EventData> evRcdHandler = new DBRecordHandler<EventData>() {
            public int handleDBRecord(EventData rcd) throws DBException {
                ...
                // -- mark device as having had an event
                // -  TODO:
        ...
        EventData ed[] = null;
        try {
            String devID = deviceDB.getDeviceID();
